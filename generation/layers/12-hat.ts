...
export async function getHat() {
  ...
  const hatOptions = [
    ...
    `<path
    d="M495.08,50h9a0,0,0,0,1,0,0V185a0,0,0,0,1,0,0h-144a0,0,0,0,1,0,0v0A135,135,0,0,1,495.08,50Z"
    style="fill:#fa6020" />
  <path
    d="M504.08,50h9a135,135,0,0,1,135,135v0a0,0,0,0,1,0,0h-144a0,0,0,0,1,0,0V50A0,0,0,0,1,504.08,50Z"
    style="fill:#d84816" />
  <rect x="388.08" y="176" width="241" height="18" style="fill:#ffa620" />`,
    undefined,
  ];
